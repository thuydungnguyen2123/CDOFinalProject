 ...
 <?php
    ...
    <div id="tong">
      ...
      <div id="tb"><?php echo $tb; ?></div>
        ...
        ?>
        <div class="ke_dau" style="color:#0C3;">
               Thông tin đăng ký
        </div>
       <div class="dau_dau" style="text-align:center">
         <table width="100%" border="0" cellspacing="2" cellpadding="2">
           <tr>
              <td colspan="2" style="color:#0C3;">Bạn phải khai báo đầy đủ mục có dánh dấu *. </td>
            </tr>
            <tr>
