...
<body>
    <div id="container">
      <div id="header" align="center"><div style="margin-top:50px;">Quản trị website Nội Thất 4 CON CÚN</div></div>
      <div id="content">
        <div id="left">
          <div class="title1" align="center">Menu</div>
          <div class="content">
            <ul>
              <li><a href="../noithat.php">Xem trang chủ <img src="../images/home_48.png" alt="Trang chủ" width="48" height="40" align="absmiddle" /></a></li>
