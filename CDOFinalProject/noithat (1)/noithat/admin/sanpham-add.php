<?php
	...
	if($xuly){
		...
		$result=sanpham_them($idLoai,$TenSP,$TenSP_KD,$NhaSX,$MoTa,$UrlHinh,$Gia,$baiviet,$SoLuongTonKho,$GhiChu,$AnHien, $ChatLieu, $KichThuoc, $MauSac, $CongNghe, $TieuChuanKiThuat, $UuNhuocDiem, $ThoiGianGiaoHang);		
	}
?>
  ...
  <table width="72%" border="0" align="center" cellpadding="5">
    ...
    <tr>
      ...
      <td bgcolor="#CCCCCC"><label for="Chất Liệu">
        <input type="text" name="ChatLieu" id="ChatLieu" />
      </label></td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td bgcolor="#CCCCCC"><label for="Tiêu Chuẩn Kĩ Thuật">
        <input type="text" name="TieuChuanKiThuat" id="TieuChuanKiThuat" />
      </label></td>
    </tr>
    <tr>
      <td bgcolor="#00FFFF" style="text-align: center; font-weight: bold;">Ưu Nhược Điểm</td>
      <td bgcolor="#CCCCCC"><label for="Ưu Nhược Điểm">
        <input type="text" name="UuNhuocDiem" id="UuNhuocDiem" />
      </label></td>
    </tr>
    <tr>
      ...
      <td bgcolor="#CCCCCC"><label for="Thời Gian Giao Hàng">
        <input type="text" name="ThoiGianGiaoHang" id="ThoiGianGiaoHang" />
      </label></td>
    </tr>
    <tr>
