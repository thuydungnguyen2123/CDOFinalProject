<?php
	...
	if($xuly){
		...
		$CongNghe=(isset($_POST['CongNghe']))?$_POST['CongNghe']:'';
		$TieuChuanKiThuat=(isset($_POST['TieuChuanKiThuat']))?$_POST['TieuChuanKiThuat']:'';
		$UuNhuocDiem=(isset($_POST['UuNhuocDiem']))?$_POST['UuNhuocDiem']:'';
		$ThoiGianGiaoHang=(isset($_POST['ThoiGianGiaoHang']))?$_POST['ThoiGianGiaoHang']:'';
		...
		$result= sanpham_capnhat($idSP,$idLoai,$TenSP,$TenSP_KD,$NhaSX,$MoTa,$UrlHinh,$Gia,$baiviet,$SoLuongTonKho,$GhiChu,$AnHien,$ChatLieu, $KichThuoc, $MauSac, $CongNghe, $TieuChuanKiThuat, $UuNhuocDiem, $ThoiGianGiaoHang);		
	}
?>
...
<form action="" method="post" enctype="multipart/form-data" name="form1">
  <table width="85%" border="0" align="center" cellpadding="5">
    ...
    <tr>
      <td bgcolor="#00FFFF" style="text-align: center; font-weight: bold;">Chất Liệu</td>
      <td bgcolor="#CCCCCC"><label for="Chất Liệu">
        <input type="text" name="ChatLieu" id="ChatLieu" value="<?php echo $row_sanpham['ChatLieu'];?>"/>
      </label></td>
    </tr>
    <tr>
      <td bgcolor="#00FFFF" style="text-align: center; font-weight: bold;">Kích Thước</td>
      <td bgcolor="#CCCCCC"><label for="Kích Thước">
        <input type="text" name="KichThuoc" id="KichThuoc" value="<?php echo $row_sanpham['KichThuoc'];?>"/>
      </label></td>
    </tr>
    <tr>
      <td bgcolor="#00FFFF" style="text-align: center; font-weight: bold;">Màu Sắc</td>
      <td bgcolor="#CCCCCC"><label for="Màu Sắc">
        <input type="text" name="MauSac" id="MauSac" value="<?php echo $row_sanpham['MauSac'];?>"/>
      </label></td>
    </tr>
    <tr>
      <td bgcolor="#00FFFF" style="text-align: center; font-weight: bold;">Công Nghệ</td>
      <td bgcolor="#CCCCCC"><label for="Công Nghệ">
        <input type="text" name="CongNghe" id="CongNghe" value="<?php echo $row_sanpham['CongNghe'];?>"/>
      </label></td>
    </tr>
    <tr>
      <td bgcolor="#00FFFF" style="text-align: center; font-weight: bold;">Tiêu Chuẩn Kĩ Thuật</td>
      <td bgcolor="#CCCCCC"><label for="Tiêu Chuẩn Kĩ Thuât">
        <input type="text" name="TieuChuanKiThuat" id="TieuChuanKiThuat" value="<?php echo $row_sanpham['TieuChuanKiThuat'];?>"/>
      </label></td>
    </tr>
    <tr>
      <td bgcolor="#00FFFF" style="text-align: center; font-weight: bold;">Ưu Nhược Điểm</td>
      <td bgcolor="#CCCCCC"><label for="Ưu Nhược Điểm">
        <input type="text" name="UuNhuocDiem" id="UuNhuocDiem" value="<?php echo $row_sanpham['UuNhuocDiem'];?>"/>
      </label></td>
    </tr>
    <tr>
      <td bgcolor="#00FFFF" style="text-align: center; font-weight: bold;">THời Gian Giao Hàng</td>
      <td bgcolor="#CCCCCC"><label for="Thời Gian Giao Hàng">
        <input type="text" name="ThoiGianGiaoHang" id="ThoiGianGiaoHang" value="<?php echo $row_sanpham['ThoiGianGiaoHang'];?>"/>
      </label></td>
    </tr>
   <tr>
