...
<table width="100%" border="0" cellspacing="3" cellpadding="3" align="center" style="text-align:center">
  ...
  <tr bgcolor="#CCCCCC">
    ...
    <td><?php if($row_sanpham['UrlHinh']!=''){?><img src="<?php echo"../imagesnoithat/".$row_sanpham['UrlHinh'];?>" alt="" name="hinhanh" width="100" height="70" id="hinhanh2" /> <?php }else{ echo" Không có hình"; }?></td>
